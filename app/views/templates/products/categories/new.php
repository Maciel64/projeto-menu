<form id="form" action="/site/<?= $site->slug; ?>/category/new" method="POST" enctype="multipart/form-data">
    ...
    <a href="/site/<?= $site->slug; ?>" class="cursor-pointer bg-sky-600 text-white p-2 transition-all hover:bg-sky-700 hover:drop-shadow-lg rounded inline-block w-fit">Voltar</a>
    <input class="cursor-pointer bg-green-600 text-white w-24 p-2 transition-all hover:bg-green-700 hover:drop-shadow-lg rounded" type="submit" value="Criar">
</form>