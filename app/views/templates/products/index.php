...
<section class="w-9/12 h-full relative ">
    <img src="/static/img/foto-fundo.jpg" alt="" class="w-full block h-60 ml-auto mr-auto rounded shadow-black shadow">

    <img src="/static/img/foto-perfil.jpeg" alt="" class=" w-28 h-28 absolute block m-auto  inset-x-0 top-44 bottom-11/12 rounded">
